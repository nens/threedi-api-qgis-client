...
SIM_DATA_LIST = [
    {
        ...
        "end_datetime": datetime.datetime(2023, 3, 3, 6, 30, 12),
        "id": 1201,
        "name": "qgis client test run 1",
        "organisation": "qwertyhash",
        "organisation_name": "Lutra Consulting",
        "start_datetime": datetime.datetime(2023, 3, 2, 10, 30, 12),
        "tags": None,
    ...
    },
    {
        ...
        "duration": 72000,
        "duration_humanized": "20 hours, 0 minutes, 0 seconds",
        "end_datetime": datetime.datetime(2023, 3, 3, 11, 19, 3),
        "id": 1202,
        "name": "qgis client test run 2",
        "organisation": "qwertyhash",
        "organisation_name": "Lutra Consulting",
        "start_datetime": datetime.datetime(2023, 3, 2, 15, 19, 3),
        "tags": None,
        "threedimodel": "https://testapi/threedimodels/14/",
        "threedimodel_id": "14",
